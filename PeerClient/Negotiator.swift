...
//                    print("Set localDescription: answer for: \(peerId)")
                    let orientationUI: String = "Another";//self!.getOrientation(orientation: options.orientation) as String
                    let message: [String: Any] = [
                        "type": "ANSWER",
                        "payload": [
                            "sdp": [
    ...
    func getOrientation(orientation: UIDeviceOrientation) -> String {
...
//        print("iceCandidateiceCandidate==\(iceCandidate)")
        pc.add(iceCandidate)
