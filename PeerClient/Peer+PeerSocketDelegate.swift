...
//                    print("metadatametadatametadata\(metadata)")
                    ...
                    DispatchQueue.main.async {
                        self.delegate?.peer(self, didReceiveConnection: mediaConnection, callMetadata: metadata)
                    }
                }
                    ...
                    DispatchQueue.main.async {
                        self.delegate?.peer(self, didReceiveConnection: dataConnection, callMetadata: "")
                    }
                }
                else {
