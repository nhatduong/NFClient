...
public class PeerOptions {
    ...
    public init(key: String, host: String, path: String, secure: Bool, port: Int, tokenPeerID: String, iceServerOptions: [PeerIceServerOptions]) {
