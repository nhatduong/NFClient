#
#  Be sure to run `pod spec lint NFClient.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Nhất Nguyễn Văn" => "nhatbg89@gmail.com" }
  # Or just: spec.author    = "Nhất Nguyễn Văn"
  # spec.authors            = { "Nhất Nguyễn Văn" => "nhatbg89@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Nhất Nguyễn Văn"
  ...
  spec.source       = { :git => "https://github.com/nhatduong/NFClient.git", :tag => "#{spec.version}" }
